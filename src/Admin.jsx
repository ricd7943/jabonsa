...
function Admin() {
  ...
  const recortarYSubir = async () => {
    ...
    try {
      ...
      // Usar las coordenadas en porcentaje directamente sobre la imagen real
        ...
        <div className="crop-modal-overlay">
          <div className="crop-modal-box" onClick={e => e.stopPropagation()}>
            ...
            <div className="crop-modal-body">
              <p className="crop-modal-hint">Arrastra las esquinas para seleccionar el área que quieres mostrar</p>
